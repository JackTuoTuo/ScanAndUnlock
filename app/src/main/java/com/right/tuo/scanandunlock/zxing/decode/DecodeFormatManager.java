...
package com.right.tuo.scanandunlock.zxing.decode;

import android.content.Intent;
import android.net.Uri;

import com.google.zxing.BarcodeFormat;
import com.right.tuo.scanandunlock.zxing.Intents;
...
public final class DecodeFormatManager {
     ...
     * @return 扫描类型数组
     */
    public static Set<BarcodeFormat> getDefaultSupportDecodeFormats() {
